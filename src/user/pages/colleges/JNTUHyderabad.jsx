...
const JNTUHyderabad = () => {
  const college = {
    ...
    description: "Jawaharlal Nehru Technological University Hyderabad is a premier public university focusing on engineering and technology education. It is one of the oldest and largest technological universities in India, serving as an affiliating university for numerous engineering and pharmacy colleges across Telangana.",
    programs: ["B.Tech", "M.Tech", "MBA", "MCA", "PhD", "B.Pharmacy", "M.Pharmacy"],
    departments: ["Computer Science", "Electronics", "Mechanical", "Civil", "Electrical", "Chemical", "Biotechnology"],
    facilities: ["Digital Library", "Research Centers", "Sports Complex", "Hostels", "Cafeteria", "Auditorium"],
